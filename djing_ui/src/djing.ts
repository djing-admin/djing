...
export class Djing {
  ...
  public async countdown() {
    ...
    await createInertiaApp({
      ...
      resolve: (name): any => {
        const page: any = !isNil(this.pages[name]) ? this.pages[name] : this.pages["Djing.Error404"]
  ...
  public async liftOff() {
    ...
    await registerViews(this)

    await registerFields(this)
  ...
  public missingResource(uriKey: string) {
    return (
