  ...
  <div class="flex justify-center items-center">
    <div class="w-full">
      ...
      <p class="leading-tight mt-3">
        Welcome to Djing! Get familiar with Djing and explore its features in
        the documentation:
      </p>
              ...
              <div class="flex space-x-4">
                ...
                <div class="space-y-2">
                  ...
                  <p class="leading-normal mt-3">
                    Our DJing application features a comprehensive resource
                    manager that allows you to efficiently view and manage your
                    track collections directly from an intuitive interface.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="p-6">
              <div class="flex space-x-4">
                ...
                <div class="space-y-2">
                  ...
                  <p class="leading-normal mt-3">
                    Actions enable you to perform tasks on individual tracks or
                    entire playlists. If an action takes longer to complete, no
                    worries—our application can queue them using a robust
            ...
            <div class="p-6">
              <div class="flex space-x-4">
                ...
                <div class="space-y-2">
                  ...
                  <p class="leading-normal mt-3">
                    Create custom filters for your track lists, allowing users
                    to easily access different music categories. Showcase
                    genres, release dates, and popular tracks for a tailored
                    browsing experience.
                  </p>
                </div>
              </div>
            ...
            <div class="p-6">
              <div class="flex space-x-4">
                ...
                <div class="space-y-2">
                  ...
                  <p class="leading-normal mt-3">
                    Need more customization than a filter can provide? Our
                    application allows you to add lenses to your track lists,
                    giving you complete control over your music library.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="p-6">
              <div class="flex space-x-4">
                ...
                <div class="space-y-2">
                  ...
                  <p class="leading-normal mt-3">
                    The DJing application makes it simple to display custom
                    metrics about your performance. With helpful query tools,
                    you'll find it easy to analyze your music usage and audience
                    engagement.
                  </p>
                </div>
              </div>
            ...
            <div class="p-6">
              <div class="flex space-x-4">
                ...
                <div class="space-y-2">
                  ...
                  <p class="leading-normal mt-3">
                    Our platform includes CLI generators for building your own
                    custom cards. We provide a Vue component along with endless
                    possibilities for enhancing your DJing experience.
                  </p>
                </div>
              </div>
            </div>
